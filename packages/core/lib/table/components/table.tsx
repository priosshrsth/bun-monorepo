...
export function Table<TData extends RowData>({
	...
	return (
		<table
			className={clsx("react-lib-table overflow-clip rounded-sm", className)}
			data-label="table"
		>
			...
			<tbody className={clsx(tbodyClassName)}>
				...
				{data.map((row, rowIndex) => (
					<tr
						className={clsx(trClassName, bodyRowClassName)}
